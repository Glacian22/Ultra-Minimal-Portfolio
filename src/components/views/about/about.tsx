...
let About = () => {
  ...
  const text = {
    ...
    background: `Fullstack Dev specializing in modern JS, Typescript, React, Redux, Node, SQL/NoSQL DBs, DevOps, CI/CD pipelines, and most importantly: thoughtfully written maintainable code paired solid testing.`,
